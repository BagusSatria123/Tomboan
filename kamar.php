...
?>
	...
	<div class="site-section bg-light">
		<div class="container">
			...
			<div class="row">
				<?php
				$sql = mysqli_query($conn, "SELECT * from galeri"); //"SELECT galeri.*,kamar.* FROM galeri INNER JOIN kamar ON kamar.No_Kamar = galeri.No_Kamar"
				foreach ($sql as $value) {
				?>
					<div class="col-md-6 col-lg-4 mb-5">
						<div class="hotel-room text-center">
							<a href="#" class="d-block mb-0 thumbnail"><img src="images/<?= $value['gambar']; ?>" class="img-fluid"></a>
							<!-- alt="Image"-->
